...
const Price = () => {
  ...
  let [infoPrice, setInfoPrice] = useState([
    ...
    "&nbsp;&nbsp;&nbsp;&nbsp;<strong>Подарочные Сертификаты</strong><br/>В конверте / Эл.виде <br/>В наличии на:<br/> -Фотосессию<br/>-«Всё включено» <br/> -Обучение<br/><br/>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<strong>Обучение</strong><br/>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Провожу обучение<br/>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;«Фотограф с О»<br/><br/>Мастер классы для начинающих &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;по студийному свету<br/>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Уроки ретуши портрета",
  ]);
